            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="post" id="admin-form" action="{{ url('admin/save_reviews') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_ar" class="form-control" required
                                                data-parsley-required-message="Enter Arabic Name" value="{{ $name_ar }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Review<b class="text-danger">&nbsp;</b></label>
                                                <textarea name="description" class="form-control" required data-parsley-required-message="Enter Review"> {{ $description }}</textarea>
                                            </div>
                                        </div>

                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Review Ar<b class="text-danger">&nbsp;</b></label>
                                                <textarea name="description_ar" class="form-control" required data-parsley-required-message="Enter Arabic Review"> {{ $description_ar }}</textarea>
                                            </div>
                                        </div>
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        if (typeof res['errors'] !== 'undefined' && res['errors']) {
                            ...
                            var m = res['message'] ||
                                'Unable to save reviews. Please try again later.';
                            show_msg(0, m)
                        }
                    } else {
                        var m = res['message'];
                        show_msg(1, m)
                        setTimeout(function() {
                            window.location.href = "{{ url('/admin/reviews') }}";
                        }, 1500);
