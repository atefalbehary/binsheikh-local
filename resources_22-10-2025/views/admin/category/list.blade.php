    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i> Property Type List</div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="margin-top: 1.8rem !important;">
                                        <button class="btn btn-primary" type="submit">Filter</button>
                                            <a href="{{ url('admin/categories') }}" class="btn btn-success dt_tables_filter_button" data-tid="dt-tbl"
                                            type="button">Reset</a>
                                    </div>
                                </div>
                            </form>
                            <button class="btn btn-primary mb-3"
                                onclick="location.href='{{ url('admin/categories/create') }}'"><i class="fas fa-plus"></i>
                                Create Property Type</button>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                <input class="toggle_status"
                                                    data-url="{{ url('admin/categories/change_status') }}" type="checkbox"
                                            ...
                                            <td>
                                                <a class="btn btn-outline-info active" title="Edit"
                                                    href="{{ url('admin/categories/edit/' . $cat->id) }}"
