                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alt_text" class="form-control"
                                            value="@if($id){{ $videos->alt_text }}@endif">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Alt Text Ar</label>
                                        <input type="text" name="alt_text_ar" class="form-control"
                                            value="@if($id){{ $videos->alt_text_ar }}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="active" class="form-control">
                                            <option <?= ($id && $videos->active == 1) ? 'selected' : '' ?> value="1">Active
                                            </option>
                                            <option <?= ($id && $videos->active == 0) ? 'selected' : '' ?> value="0">
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <a href="{{url('admin/videos')}}" class="btn btn-secondary"
