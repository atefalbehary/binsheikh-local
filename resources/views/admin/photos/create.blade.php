                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="gallery[]" class="form-control" data-role="file-image"
                                        ...
                                        <span class="text-danger">Upload images with dimensions 800 x 467 Or it's
                                            proportions</span>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        <label>Default Alt Text Ar</label>
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <a href="{{url('admin/photos')}}" class="btn btn-secondary"
