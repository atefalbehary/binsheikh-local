                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" required
                                            ...
                                            value="@if($id){{$project->name}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" class="form-control" required
                                            ...
                                            value="@if($id){{$project->name_ar}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" class="form-control" required
                                            ...
                                            value="@if($id){{$project->location}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location_ar" class="form-control" required
                                            ...
                                            value="@if($id){{$project->location_ar}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input <?=!$id ? 'required' : '' ?> data-parsley-required-message="Select Image"
                                        ...
                                        @if($id && $project->image) <a href=" {{aws_asset_path($project->image) }}"
                                        target="_blank" rel="noopener noreferrer">View Image</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input <?=!$id ? 'required' : '' ?> data-parsley-required-message="Select Image"
                                            type="file" name="app_image" class="form-control" accept="image/*"
                                            data-parsley-trigger="change" data-parsley-fileextension="jpg,png,gif,jpeg"
                                            data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg are supported"
                                            data-parsley-max-file-size="5120"
                                            data-parsley-max-file-size-message="Max file size should be 5MB">
                                        @if($id && $project->app_image) <a
                                            href=" {{aws_asset_path($project->app_image) }}" target="_blank"
                                        rel="noopener noreferrer">View Image</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input <?=!$id ? 'required' : '' ?>
                                            data-parsley-required-message="Select Banner" type="file" name="banner"
                                            class="form-control" accept="image/*" data-parsley-trigger="change"
                                            data-parsley-fileextension="jpg,png,gif,jpeg"
                                            data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg are supported"
                                            data-parsley-max-file-size="5120"
                                            data-parsley-max-file-size-message="Max file size should be 5MB">
                                        @if($id && $project->banner) <a href=" {{aws_asset_path($project->banner) }}"
                                        target="_blank" rel="noopener noreferrer">View Banner</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" data-parsley-required-message="Enter 360 Link" name="link_360"
                                            class="form-control" value="@if($id){{$project->link_360}}@endif">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country" class="form-control select2" required
                                            ...
                                            @foreach($project_countries as $val)
                                                <option <?= ($id && $project->country == $val->id) ? 'selected' : '' ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="month" required
                                            data-parsley-required-message="Enter Project End Date" name="end_date"
                                            class="form-control" value="@if($id){{$project->end_date}}@endif"
                                            autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="active" class="form-control">
                                            <option <?= ($id && $project->active == 1) ? 'selected' : '' ?> value="1">
                                                Active</option>
                                            <option <?= ($id && $project->active == 0) ? 'selected' : '' ?> value="0">
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control editor" required
                                            data-parsley-required-message="Enter Description">@if($id){{$project->description}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_ar" class="form-control editor" required
                                            data-parsley-required-message="Enter Arabic Description">@if($id){{$project->description_ar}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input <?=!$id ? 'required' : '' ?> data-parsley-required-message="Select Video"
                                            type="file" name="video" class="form-control" data-parsley-trigger="change"
                                            accept="video/*">
                                        @if($id && $project->video) <a href=" {{aws_asset_path($project->video) }}"
                                        target="_blank" rel="noopener noreferrer">View Video</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input <?=!$id ? 'required' : '' ?>
                                            data-parsley-required-message="Select Video Thumbnail" type="file"
                                            name="video_thumbnail" class="form-control" data-parsley-trigger="change "
                                            accept="image/*">
                                        @if($id && $project->video_thumbnail) <a
                                            href="{{aws_asset_path($project->video_thumbnail) }}" target="_blank"
                                        rel="noopener noreferrer">View Thumbnail </a> @endif
                                    </div>
                                </div>
                                                ...
                                                <div style="float: left;margin-top: 30px;">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <input type="text" name="image_alt_text[{{ $img->id }}]"
                                                            class="form-control form-control-sm" value="{{ $img->alt_text }}"
                                                            placeholder="Alt Text">
                                                    </div>
                                                    <div class="mt-2">
                                                        <label class="small">Alt Text Ar:</label>
                                                        <input type="text" name="image_alt_text_ar[{{ $img->id }}]"
                                                            class="form-control form-control-sm" value="{{ $img->alt_text_ar }}"
                                ...
                                <div class="itinerary col-md-12 mb-5" style="background-color: lightgray">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Image<b class="text-danger">&nbsp;</b></label>
                                                <input @if(!$id) required @endif
                                                    data-parsley-required-message="Select Image" type="file"
                                                    name="prj_image[0]" class="form-control" accept="image/*"
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="text" name="prj_image_alt_text[0]" class="form-control"
                                                    placeholder="Alt Text">
                                            </div>
                                            <div class="form-group mt-2">
                                                <label>Alt Text Ar</label>
                                                <input type="text" name="prj_image_alt_text_ar[0]" class="form-control"
                                                    placeholder="Alt Text Ar">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="prj_image_type[0]" class="form-control" @if(!$id) required
                                                @endif data-parsley-required-message="Select Type">
        ...
        _html =
            `<div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group mt-2">
                            <label>Alt Text</label>
                            <input type="text" name="prj_image_alt_text[${faq_index}]" class="form-control" placeholder="Alt Text">
                        </div>
                        <div class="form-group mt-2">
                            <label>Alt Text Ar</label>
                            <input type="text" name="prj_image_alt_text_ar[${faq_index}]" class="form-control" placeholder="Alt Text Ar">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
