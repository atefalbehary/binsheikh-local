                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" required
                                            ...
                                            value="@if($id){{$property->name}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" class="form-control" required
                                            data-parsley-required-message="Enter Arabic Name"
                                            value="@if($id){{$property->name_ar}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" class="form-control" required
                                            data-parsley-required-message="Enter Location"
                                            value="@if($id){{$property->location}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location_ar" class="form-control" required
                                            data-parsley-required-message="Enter Location Name"
                                            value="@if($id){{$property->location_ar}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-parsley-type="number" name="price" class="form-control"
                                            required data-parsley-required-message="Enter Price"
                                            value="@if($id){{$property->price}}@endif">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="project_id" class="form-control select2" required
                                            ...
                                            @foreach($projects as $val)
                                                <option <?= ($id && $property->project_id == $val->id) ? 'selected' : '' ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-parsley-type="digits" name="bedrooms"
                                            class="form-control" required
                                            data-parsley-required-message="Enter Bedroom Count"
                                            value="@if($id){{$property->bedrooms}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-parsley-type="digits" name="bathrooms"
                                            class="form-control" required
                                            data-parsley-required-message="Enter Bathroom Count"
                                            value="@if($id){{$property->bathrooms}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gross_area" class="form-control" required
                                            data-parsley-required-message="Enter Gross Area"
                                            value="@if($id){{$property->gross_area}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="balcony_size" class="form-control"
                                            data-parsley-required-message="Enter Balcony Size"
                                            value="@if($id){{$property->balcony_size}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="area" data-parsley-type="number" class="form-control"
                                            required data-parsley-required-message="Enter Net Area"
                                            value="@if($id){{$property->area}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location_link" class="form-control" required
                                            ...
                                            value="@if($id){{$property->location_link}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sale_type" class="form-control select2" required
                                            ...
                                            <option value="">Select</option>
                                            <option <?= ($id && $property->sale_type == 1) ? 'selected' : '' ?> value="1">
                                                Buy</option>
                                            <option <?= ($id && $property->sale_type == 2) ? 'selected' : '' ?> value="2">
                                                Rent</option>

                                            <option <?= ($id && $property->sale_type == 3) ? 'selected' : '' ?> value="3">
                                                Buy & Rent</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category" class="form-control" required
                                            ...
                                            @foreach($categories as $val)
                                                <option <?= ($id && $property->category == $val->id) ? 'selected' : '' ?>
                                                    value="{{$val->id}}">{{$val->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="active" class="form-control">
                                            <option <?= ($id && $property->active == 1) ? 'selected' : '' ?> value="1">
                                                Active</option>
                                            <option <?= ($id && $property->active == 0) ? 'selected' : '' ?> value="0">
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apartment_no" class="form-control"
                                            value="@if($id){{$property->apartment_no}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required data-parsley-required-message="Enter Floor Number"
                                            data-parsley-type="integer"
                                            data-parsley-type-message="Enter a valid floor number" type="text"
                                            name="floor_no" class="form-control"
                                            value="@if($id){{$property->floor_no}}@endif">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="is_recommended">Is Recommended <small class="text-info">To Show In
                                                Home Page</small></label> <br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="is_featured">Is Featured <small class="text-info">To Highlight in
                                                Listings</small></label> <br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Similar Properties <small class="text-info">Select properties that are
                                                similar to this one</small></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Order</label>
                                        <input required data-parsley-required-message="Enter Order "
                                            data-parsley-type="integer" data-parsley-type-message="Enter a valid order"
                                            type="text" name="order" class="form-control"
                                            value="@if($id){{$property->order}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control" required
                                            data-parsley-required-message="Enter Short Description">@if($id){{$property->short_description}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description_ar" class="form-control" required
                                            data-parsley-required-message="Enter Arabic Short Description">@if($id){{$property->short_description_ar}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control editor" required
                                            data-parsley-required-message="Enter Description">@if($id){{$property->description}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_ar" class="form-control editor" required
                                            data-parsley-required-message="Enter Arabic Description">@if($id){{$property->description_ar}}@endif</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="broucher" class="form-control"
                                            data-parsley-trigger="change" data-parsley-fileextension="pdf"
                                        ...
                                        @if($id && $property->broucher) <a
                                            href=" {{aws_asset_path($property->broucher) }}" target="_blank"
                                        rel="noopener noreferrer">View Broucher</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        @if($id && $property->floor_plan) <a
                                            href="{{aws_asset_path($property->floor_plan) }}" target="_blank"
                                        rel="noopener noreferrer">View Plan</a> @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Video <small>Youtube Embed Link</small><b
                                                class="text-danger">&nbsp;</b></label>
                                        <input type="url" name="video_link" class="form-control" required
                                            data-parsley-pattern="^https:\/\/www\.youtube\.com\/embed\/([a-zA-Z0-9_-]{11})(\?[\w=&]*)?$"
                                            data-parsley-pattern-message="Please enter a valid YouTube embed URL."
                                            data-parsley-required-message="Enter Embed Link"
                                            value="@if($id){{ $property->video_link }} @endif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="link_360" class="form-control"
                                            value="@if($id){{$property->link_360}}@endif"
                                            data-parsley-required-message="Enter 360 Link">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="unit_layout" class="form-control"
                                            value="@if($id){{$property->unit_layout}}@endif"
                                            data-parsley-required-message="Enter Unit Layout">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="meta_title" class="form-control jqv-input"
                                        value="@if($id){{ $property->meta_title }}@endif" placeholder="Meta Title">
                                </div>

                                <div class="col-md-6 form-group">
                                    <label>Meta Title Ar<b class="text-danger">&nbsp;</b></label>
                                    <input type="text" name="meta_title_ar" class="form-control jqv-input"
                                        value="@if($id){{ $property->meta_title_ar }}@endif"
                                        placeholder="Meta Title Arabic">
                                </div>

                                <div class="col-md-6 form-group">
                                    <label>Meta Description<b class="text-danger">&nbsp;</b></label>
                                    <textarea name="meta_description" class="form-control jqv-input"
                                        placeholder="Meta Description">@if($id){{$property->meta_description}}@endif</textarea>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label>Meta Description Ar<b class="text-danger">&nbsp;</b></label>
                                    <textarea name="meta_description_ar" class="form-control jqv-input"
                                        placeholder="Meta Description Arabic">@if($id){{$property->meta_description_ar}}@endif</textarea>
                                </div>
                                ...
                                @if (count($images) > 0)
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" id="delete-selected-images"
                                            class="btn btn-danger btn-sm float-right mb-2" style="display:none;">Delete
                                            Selected Images</button>
                                        <button type="button" id="select-all-images"
                                            class="btn btn-secondary btn-sm float-right mb-2 mr-2">Select All</button>
                                    </div>
                                                ...
                                                <div style="float: left;margin-top: 30px;">
                                                    <div class="image-container position-relative">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <input type="number" id="image-order-{{ $img->id }}"
                                                                name="image_order[{{ $img->id }}]"
                                                                class="form-control form-control-sm image-order"
                                                                value="{{ $img->order ?? 0 }}" min="0" style="width: 70px;">
                                                        </div>
                                                        <div class="mt-2">
                                                            <label class="small">Alt Text:</label>
                                                            <input type="text" name="image_alt_text[{{ $img->id }}]"
                                                                class="form-control form-control-sm"
                                                                value="{{ $img->alt_text }}" placeholder="Alt Text">
                                                        </div>
                                                        <div class="mt-2">
                                                            <label class="small">Alt Text Ar:</label>
                                                            <input type="text" name="image_alt_text_ar[{{ $img->id }}]"
                                                                class="form-control form-control-sm"
                                                                value="{{ $img->alt_text_ar }}" placeholder="Alt Text Ar">
                                                        </div>
                                                        <a class="remove deleteListItem" data-role="unlink"
                                                            data-message="Do you want to remove this image?" title="Delete"
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input @if (!$id) data-parsley-required-message="Select Property Images" @endif
                                            type="file" name="images[]" class="form-control" data-role="file-image"
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="form-group">
                                        <label>Default Alt Text (New Images)</label>
                                        <input type="text" name="new_image_alt_text" class="form-control" placeholder="Applied to all new images">
                                    </div>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <div class="form-group">
                                        <label>Default Alt Text Ar (New Images)</label>
                                        <input type="text" name="new_image_alt_text_ar" class="form-control" placeholder="Applied to all new images">
                                    </div>
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <a href="{{url('admin/properties')}}" class="btn btn-secondary"
