...
<div class="wrapper">
    ...
    <div class="content">
                                ...
                                <div class="user-dasboard-menu_wrap">
                                    <div class="user-dasboard-menu-header">
                                        <div class="user-dasboard-menu_header-avatar">
                                            <img src="{{ asset('') }}front-assets/images/avatar/profile-icon.png"
                                                alt="">
                                            <span> <strong>{{ \Auth::user()->name }}</strong></span>

                                            <div class="db-menu_modile_btn"><strong>{{ __('messages.menu') }}</strong><i
                                    ...
                                    <div class="user-dasboard-menu faq-nav">
                                        <ul>
                                            <li><a href="{{ url('my-profile') }}"
                                                    class="act-scrlink">{{ __('messages.profile') }}</a></li>

                                            @if(\Auth::user()->role == 4)
                                                <li><a href="{{ url('my-employees') }}">{{ __('messages.employees') }}</a>
                                                </li>
                                            @endif

                                            <li><a
                                                    href="{{ url('my-reservations') }}">{{ __('messages.my_reservations') }}</a>
                                            </li>
                                            <li><a href="{{ url('favorite') }}">{{ __('messages.my_favorite') }}
                                                    <!-- <span>6</span> -->
                                                </a></li>
                                            @if(\Auth::user()->role == 4 || \Auth::user()->role == 3)
                                                <li><a href="{{ url('visit-schedule') }}"
                                                        style="background-color: rgb(242, 233, 224);">{{ __('messages.my_visit_schedule') }}</a>
                                                </li>
                                            @endif
                                        </ul>
                                        <a href="{{ url('user/logout') }}" class="hum_log-out_btn"><i
                                                class="fa-light fa-power-off"></i> {{ __('messages.log_out') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="custom-form bg-white p-4 h-100">
                                        ...
                                        <div class="dashboard-title">
                                            <div class="dashboard-title-item">
                                                <span>{{ __('messages.visit_schedule') }}</span>
                                            </div>
                                            <div class="dashboard-title-actions">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#addVisitScheduleModal">
                                                    <i class="fas fa-plus"></i>
                                                    {{ __('messages.add_new_visit_schedule') }}
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="visit-schedule-header">
                                            <div class="search-section">
                                                <div class="search-bar">
                                                    <input type="text" class="form-control"
                                                        placeholder="{{ __('messages.search_by_name_email_phone') }}"
                                            ...
                                            <div class="filters-section">
                                                ...
                                                <div class="selection-info">
                                                    <span id="selectedCountVisit">0 of 0
                                                        {{ __('messages.visits_selected') }}</span>
                                                </div>

                                                <div class="action-buttons">
                                                    <button class="btn btn-primary btn-sm"
                                                        id="exportVisitSchedulesBtn">{{ __('messages.export') }}</button>
                                                    <button class="btn btn-danger btn-sm"
                                                        id="deleteVisitSchedulesBtn">{{ __('messages.delete') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-hover" id="visitScheduleTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ __('messages.visit_status') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                    ...
                    <div class="modal-body custom-modal-body">
                        ...
                        <form id="forgetPasswordForm" action="{{ url('forget_password') }}" method="POST">
                            ...
                            <div class="email-input-container">
                                <input type="email" class="custom-email-input" name="email"
                ...
                <div class="modal-content custom-modal-content">
                    ...
                    <div class="modal-body custom-modal-body">
                        ...
                        <h4 class="modal-title custom-modal-title">
                            {{ __('messages.verified_please_enter_new_password') }}
                        </h4>
                        ...
                        <form id="newPasswordForm" action="{{ url('update_forget_password') }}" method="POST">
                            ...
                            <div class="new-password-input-container">
                                <input type="password" class="custom-new-password-input" name="new_password"
        ...
        <div class="modal fade" id="addVisitScheduleModal" tabindex="-1" aria-labelledby="addVisitScheduleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content" style="max-height: 90vh;">
                    ...
                    <form id="addVisitScheduleForm" action="{{ url('visit-schedule/store') }}" method="POST"
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="client_id"
                                                    class="form-label">{{ __('messages.client_id') }}</label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                                    <input type="file" class="form-control" id="client_id"
                                                        name="client_id" accept=".jpg,.jpeg,.png,.pdf">
                                                    <button type="button"
                                                        class="btn btn-outline-secondary">{{ __('messages.choose_file') }}</button>
                                                </div>
                                                <!-- Hidden field for existing path -->
                                                <input type="hidden" id="existing_client_id_path"
                                                    name="existing_client_id_path">
                                                <!-- Link to existing ID card -->
                                                <div id="existing_client_id_container" class="mt-2"
                                                    style="display:none;">
                                                    <small class="text-success"><i class="fas fa-check-circle"></i>
                                                        {{ __('messages.client_id_on_file') ?? 'ID Card selected' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-section">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="unit_type"
                                                    class="form-label">{{ __('messages.unit_type') }}</label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i
                                                            class="fas fa-building"></i></span>
                                                    <input type="text" class="form-control" id="unit_type"
                                                        name="unit_type"
                                                        placeholder="{{ __('messages.enter_unit_type') }}">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="visit_time"
                                                                class="form-label">{{ __('messages.time') }}</label>
                                                            <div class="input-group">
                                                                <span class="input-group-text"><i
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="notes" name="notes" rows="3"
                                                        placeholder="{{ __('messages.enter_your_main_message_here') }}"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            `);
                ...
                $(document).on('click', '.client-item', function (e) {
                    ...
                    // Handle ID Card Pre-fill
                    if (idCard || qid) {
                        const docPath = idCard || qid;
                        $('#existing_client_id_path').val(docPath);
                        $('#existing_client_id_container').show();
                    } else {
