...
@section('content')
    ...
    @if(isset($popup) && $popup)
        <div class="modal fade" id="popupModal" tabindex="-1" aria-hidden="true">
            <!-- Desktop Modal -->
            <div class="modal-dialog modal-dialog-centered popup-modal-dialog d-none d-md-flex">
                                ...
                                <div class="text-center d-flex flex-column h-100">
                                    ...
                                    <div class="popup-text-content">
                                        <h4 class="popup-title">
                                            <span class="popup-title-bold">{{ $popup->title }}</span>
                                        </h4>
            ...
            <div class="modal-dialog modal-fullscreen m-0 p-0 d-flex d-md-none">
                <div class="modal-content border-0 popup-modal-content">
                    <!-- Close Button -->
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-2 bg-white p-1 rounded-circle shadow-sm" data-bs-dismiss="modal" aria-label="Close" style="z-index: 1030; opacity: 0.9; transform: scale(1.1);"></button>
                    <div class="modal-body p-0">
                            <!-- Left Column - Image -->
    ...
    <div class="wrapper">
        <div class="content bg-gray">
            ...
            <div class=" ">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115454.05320697768!2d51.36538344335935!3d25.272631900000007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45d19ebfd9e52d%3A0x537aa5ec0e9fd03f!2zQmluIEFsIFNoZWlraCBCcm9rZXJhZ2UgfCDYqNmGINin2YTYtNmK2K4g2YTZhNmI2LPYp9i32Kkg2KfZhNi52YLYp9ix2YrYqQ!5e0!3m2!1sen!2sqa!4v1768469576184!5m2!1sen!2sqa" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"  width="100%" height="500px" ></iframe>
