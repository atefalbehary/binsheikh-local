...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; ">
    ...
    $apiUrl = "https://messaging.ooredoo.qa/bms/api/Sms";
    $data = [
        "From" => 'BinAlSheikh',
        "To" => $to,
        "Text" => $text,
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        ...
        "Authorization: Basic " . base64_encode("$username:$password") // Fixed to use colon
    ]);

    $response = curl_exec($ch);
    $httpCode = curl_getinfo($ch, CURLINFO_HTTP_CODE);
    
    Log::info('API Response:', ['code' => $httpCode, 'response' => $response]);
