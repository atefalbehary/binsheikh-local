...
<div class="container">
    <div class="header">Admin Approval for Login</div>

    {{-- <p>Hello,</p> --}}
    <p>Admin approved your registration, now you can log in to  <span class="company-name">Bin Al Sheikh</span>.
       </p>
    <p>If you are not concern, please ignore this email.</p>
