    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i> Branch Wise Sales Report</div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3" styles="margin-top: 1.8rem !important;">
                                        ...
                                        <input type="submit" name="excel" value="Export" class="btn btn-primary" >
                                            <a href="{{ url('admin/report/branch_sales') }}" class="btn btn-success dt_tables_filter_button" data-tid="dt-tbl"
                                            type="button">Reset</a>
                                    </div>
                                </div>
                            </form>
