                                        ...
                                        <div class="boxed-container">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="card p-2">
                                                        <?php
                                                            ...
                                                            $down_payment = $down_payment_p;
                                                            $down_payment_with_ser_amt = $down_payment_p + $ser_amt;
                                                            $down_payment_without_ser_amt = $down_payment_p;
                                                            ...
                                                            <table class="payment-table table">
                                                                ...
                                                                <tbody>
                                                                    <tr class="payment-row-highlight">
                                                                        ...
                                                                        <td>{{ date('M-y') }}</td>
                                                                        <td>{{ moneyFormat($down_payment_p) }}</td>
                                                ...
                                                <div class="col-md-4 text-start">
                                                    ...
                                                    <form action="{{ url('specific-book-now', $property->id) }}" method="get" data-parsley-validate="true">
                                                        <input type="hidden" name="down_payment" id="down_payment_input" value="{{ $down_payment_p }}">
