...
<head>
    ...
    <title>Password Reset OTP - Bin Al Sheikh</title>
    <style>
...
<div class="container">
    <div class="header">Your OTP Code for Password Reset</div>

    <p>You have requested to reset your password for <span class="company-name">Bin Al Sheikh</span>.
       Use the OTP below to proceed with resetting your password. This OTP is valid for 10 minutes.</p>
