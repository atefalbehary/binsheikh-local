    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><i class="fa fa-align-justify"></i> Folders</div>
                        <div class="card-body">
                            <button class="btn btn-primary mb-3" onclick="location.href='{{ url('admin/folders/create') }}'"><i
                                    class="fas fa-plus"></i>
                            ...
                            <table class="table table-responsive-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($list as $item)
                                        <?php
                                            $i++;
                                            $checked = $item->is_pinned ? 'checked' : '';
                                        ?>
                                        <tr role="row">
                                            ...
                                            <td>
                                                <input class="toggle_status"
                                                    data-url="{{ url('admin/folders/change_status') }}" type="checkbox"
                                            ...
                                            <td>
                                                <a href="{{ url('admin/folders/delete/' . $item->id) }}"
        ...
        document.getElementById('deleteSelected').addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    form.method = 'POST';
                    form.action = '{{ route("admin.folders.deleteAll") }}';
