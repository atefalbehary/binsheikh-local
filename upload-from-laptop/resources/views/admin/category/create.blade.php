            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="post" id="admin-form" action="{{ url('admin/save_categories') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <a href="{{url('admin/categories')}}" class="btn btn-secondary"  data-bs-dismiss="modal">{{__('Back')}}  </a>
                                        </div>
                                    </div>
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        if (typeof res['errors'] !== 'undefined' && res['errors']) {
                            ...
                            var m = res['message'] ||
                                'Unable to save categories. Please try again later.';
                            show_msg(0, m)
                        }
                    } else {
                        var m = res['message'];
