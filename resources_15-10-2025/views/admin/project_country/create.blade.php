                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><strong>
                                ...
                                @else
                                    Add
                                @endif Project Country
                            </strong></div>
                        <form method="post" id="admin-form" action="{{ url('admin/save_project_countries') }}"
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        if (typeof res['errors'] !== 'undefined' && res['errors']) {
                            ...
                            var m = res['message'] ||
                                'Unable to save project_countries. Please try again later.';
                            show_msg(0, m)
                        }
                    } else {
                        var m = res['message'];
                        show_msg(1, m)
                        setTimeout(function() {
                            window.location.href = "{{ url('/admin/project_countries') }}";
                        }, 1500);
